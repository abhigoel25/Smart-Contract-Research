...
1. **InnovateTe_FutureInve.sol** - Solidity smart contract (92 lines)
2. **InnovateTe_FutureInve.abi.json** - Contract ABI (10 elements)
...
### MCP Server
5. **InnovateTe_FutureInve_mcp_server.py** - Custom MCP server (127 lines)
...
- `activateNDA()` - State-changing transaction
- `terminateNDA()` - State-changing transaction
