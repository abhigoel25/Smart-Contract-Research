...
contract LoanAgreement {
    ...
    function getObligations() external view returns (string memory obligation1, string memory obligation2) {
        obligation1 = "Make monthly payments";
        obligation2 = "Maintain insurance on collateral at full value";
        return (obligation1, obligation2);
    }
}