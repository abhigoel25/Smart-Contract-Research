...
1. **InnovateTe_FutureInve.sol** - Solidity smart contract (106 lines)
2. **InnovateTe_FutureInve.abi.json** - Contract ABI (4 elements)
...
### MCP Server
5. **InnovateTe_FutureInve_mcp_server.py** - Custom MCP server (76 lines)
