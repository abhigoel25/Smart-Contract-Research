...
1. **InnovateTe_FutureInve.sol** - Solidity smart contract (29 lines)
2. **InnovateTe_FutureInve.abi.json** - Contract ABI (6 elements)
...
### MCP Server
5. **InnovateTe_FutureInve_mcp_server.py** - Custom MCP server (87 lines)
