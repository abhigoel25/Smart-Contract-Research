...
1. **TechCorp_I_Robert_Joh.sol** - Solidity smart contract (69 lines)
2. **TechCorp_I_Robert_Joh.abi.json** - Contract ABI (10 elements)
...
### MCP Server
5. **TechCorp_I_Robert_Joh_mcp_server.py** - Custom MCP server (125 lines)
...
- `getSalary()` - Read-only query
- `getPerformanceBonus()` - Read-only query
- `getStockOptions()` - Read-only query
