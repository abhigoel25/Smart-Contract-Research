...
1. **InnovateTe_FutureInve.sol** - Solidity smart contract (105 lines)
2. **InnovateTe_FutureInve.abi.json** - Contract ABI (13 elements)
...
### MCP Server
5. **InnovateTe_FutureInve_mcp_server.py** - Custom MCP server (182 lines)
