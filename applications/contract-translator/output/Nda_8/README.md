...
1. **InnovateTe_FutureInve.sol** - Solidity smart contract (139 lines)
...
### MCP Server
5. **InnovateTe_FutureInve_mcp_server.py** - Custom MCP server (134 lines)
