...
1. **BlockChain_Venture_Ca.sol** - Solidity smart contract (50 lines)
...
### MCP Server
5. **BlockChain_Venture_Ca_mcp_server.py** - Custom MCP server (126 lines)
...
- `areSharesRedeemed()` - Read-only query
