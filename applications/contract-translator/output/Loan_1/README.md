...
1. **Capital_Fi_GreenTech_.sol** - Solidity smart contract (100 lines)
...
### MCP Server
5. **Capital_Fi_GreenTech__mcp_server.py** - Custom MCP server (109 lines)
...
- `makePayment()` - Payable transaction
- `defaultLoan()` - State-changing transaction
