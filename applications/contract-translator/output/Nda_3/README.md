...
1. **InnovateTe_FutureInve.sol** - Solidity smart contract (56 lines)
...
### MCP Server
5. **InnovateTe_FutureInve_mcp_server.py** - Custom MCP server (99 lines)
...
- `reportConfidentialityBreach()` - State-changing transaction
- `getNdaDetails()` - Read-only query
