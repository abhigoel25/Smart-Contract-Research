...
1. **BlockChain_Venture_Ca.sol** - Solidity smart contract (90 lines)
2. **BlockChain_Venture_Ca.abi.json** - Contract ABI (7 elements)
...
### MCP Server
5. **BlockChain_Venture_Ca_mcp_server.py** - Custom MCP server (114 lines)
