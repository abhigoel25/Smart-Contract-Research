...
1. **BlockChain_Venture_Ca.sol** - Solidity smart contract (66 lines)
2. **BlockChain_Venture_Ca.abi.json** - Contract ABI (11 elements)
...
### MCP Server
5. **BlockChain_Venture_Ca_mcp_server.py** - Custom MCP server (159 lines)
...
- `getSharesQuantity()` - Read-only query
- `isSharesRedeemed()` - Read-only query
